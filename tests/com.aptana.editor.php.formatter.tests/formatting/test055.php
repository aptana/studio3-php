...
php.formatter.wrap.comments.length=20
 ...
 * filters
 * @link
 * http://www.php.net/manual/en/function.filter-list.php
 * @return array an
 * array of names of
 * all supported
 * filters, empty
 ...
 * exists
 * @link
 * http://www.php.net/manual/en/function.filter-has-var.php
 * @param type int
 * <p>
 * One of INPUT_GET,
 * INPUT_POST,
 ...
 * named filter
 * @link
 * http://www.php.net/manual/en/function.filter-id.php
 * @param filtername
 * string <p>
 * Name of a filter
 * to get.
