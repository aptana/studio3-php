...
php.formatter.newline.between.array.creation.elements=true
...
php.formatter.spaces.after.invocation.parentheses.opening=1
...
php.formatter.spaces.before.assignment=0
...
php.formatter.spaces.before.invocation.parentheses.opening=1
php.formatter.spaces.after.array.access.parentheses.opening=0
==CONTENT==
<?php
$example = array("fields" => array("id" => array("type" => "serial",
	'unsigned' => TRUE,
	"not null" => TRUE, ),
	"uc_tax_id" => array("type" => "int",
		'unsigned' => TRUE,
		'size' => 'tiny',
		"not null" => TRUE,
		'default' => 0, ),
	"taxonomy_terms" => array('description' => t('Serialized array of taxonomy terms to be taxed.'),
		'type' => 'text',
		'serialize' => TRUE, ), ),
