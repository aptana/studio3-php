...
php.formatter.spaces.before.array.access.parentheses.closing=1
...
php.formatter.spaces.before.array.access.parentheses.opening=1
...
php.formatter.spaces.after.array.access.parentheses.opening=1
==CONTENT==
<?php
function signup() {
