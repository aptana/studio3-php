...
php.formatter.spaces.after.dot=0
php.formatter.spaces.after.relational=1
php.formatter.spaces.before.dot=0
...
==CONTENT==
<?php
define("PF_DEFAULT_VID",  9);
define( "PF_DEFAULT_TYPE", 'nonprofit' );
 
function personal_fundraiser_init () {
  	
	$path = drupal_get_path('module',  'personal_fundraiser');
  drupal_add_js(array('personalFundraiser' =>array()), 'setting');
  drupal_add_js($path .  '/personal_fundraiser.js');
	drupal_add_css($path  . '/personal_fundraiser.css');
}
==FORMATTED==
