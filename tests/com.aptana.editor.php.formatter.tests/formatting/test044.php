...
php.formatter.spaces.before.keyValue=0
...
<?php
	function createAdminMenu() {
		$menu = array("Item1" => array("subitem1.php" => "Sub1",
			"subitem2.php" => "Sub2"),
		//"Item2" => array("subitem3.php" => "Sub3"),
		);
	}
==FORMATTED==

function createAdminMenu() {
	$menu = array("Item1"=> array("subitem1.php"=>"Sub1", "subitem2.php"=>"Sub2"),
	//"Item2" => array("subitem3.php" => "Sub3"),
	);
}
