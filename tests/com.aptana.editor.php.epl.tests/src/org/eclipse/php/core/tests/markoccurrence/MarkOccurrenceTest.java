...
public class MarkOccurrenceTest extends AbstractPDTTTest
{
	...
	public MarkOccurrenceTest(String description)
	{
		super(description);
	}
			...
			for (String testsDirectory : TESTS.get(phpVersion))
			{
				...
				for (final String fileName : getPDTTFiles(testsDirectory))
				{
					try
					{
						...
						phpVerSuite.addTest(new MarkOccurrenceTest(phpVersion.getAlias() + " - /" + fileName)
						{
