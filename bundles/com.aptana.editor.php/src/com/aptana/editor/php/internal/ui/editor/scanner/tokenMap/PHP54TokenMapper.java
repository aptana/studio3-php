...
import org2.eclipse.php.internal.core.ast.scanner.php54.ParserConstants;
...
public class PHP54TokenMapper implements IPHPTokenMapper, ParserConstants
{
	...
	public IToken mapToken(Symbol sym, PHPCodeScanner scanner)
	{
		switch (sym.sym)
		{
			...
			case T_TRAIT:
				return scanner.getToken(PHPTokenType.STORAGE_TYPE_TRAIT);
			case T_VAR:
			case T_GLOBAL:
			case T_INTERFACE:
