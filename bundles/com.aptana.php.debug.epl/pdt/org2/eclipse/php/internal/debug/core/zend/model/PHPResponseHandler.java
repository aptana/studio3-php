...
public class PHPResponseHandler {
	...
	public class StartResponseHandler implements org2.eclipse.php.internal.debug.core.zend.debugger.Debugger.StartResponseHandler {
	...
	public class BreakpointAddedResponseHandler implements org2.eclipse.php.internal.debug.core.zend.debugger.Debugger.BreakpointAddedResponseHandler {
		...
		public void breakpointAdded(String fileName, int lineNumber, int id, boolean success) {
			...
			if (success) {
				...
				if (breakpoint != null) {
					...
					org2.eclipse.php.internal.debug.core.zend.debugger.Breakpoint rbp = lineBreakpoint.getRuntimeBreakpoint();
					rbp.setID(id);
				} else {
	...
	public class BreakpointRemovedResponseHandler implements org2.eclipse.php.internal.debug.core.zend.debugger.Debugger.BreakpointRemovedResponseHandler {
...
//                Logger.log(Logger.ERROR, "PHPResponseHandler: BreakpointRemovedResponseHandler failed " + id);
	...
	public class StepIntoResponseHandler implements org2.eclipse.php.internal.debug.core.zend.debugger.Debugger.StepIntoResponseHandler {
	...
	public class StepOverResponseHandler implements org2.eclipse.php.internal.debug.core.zend.debugger.Debugger.StepOverResponseHandler {
	...
	public class StepOutResponseHandler implements org2.eclipse.php.internal.debug.core.zend.debugger.Debugger.StepOutResponseHandler {
	...
	public class GoResponseHandler implements org2.eclipse.php.internal.debug.core.zend.debugger.Debugger.GoResponseHandler {
	...
	public class PauseResponseHandler implements org2.eclipse.php.internal.debug.core.zend.debugger.Debugger.PauseResponseHandler {
