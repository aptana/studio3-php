...
import com.aptana.editor.php.core.PHPCoreConstants;
...
public class PHPVersionProvider
{
	...
	private static PHPVersion getVersion(IProject project, String prefKey)
	{
		...
		String versionAlias = service.getString(PHPEditorPlugin.PLUGIN_ID, prefKey, PHPCoreConstants.PHP5, contexts);
