package com.aptana.debug.php.ui.actions;
...
import com.aptana.debug.php.ui.display.PHPInspectExpression;
...
{
	private static final String INSPECT_COMMAND_DEFINITION_ID = "com.aptana.debug.php.ui.command.Inspect"; //$NON-NLS-1$
