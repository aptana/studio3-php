...
public interface ICommunicationDaemon
{
	...
	/**
	 * Handle an error of Multiple Bindings, which means that the two daemon instances are trying to connect on the same
	 * port.
	 */
	...
	/**
	 * Returns true if the daemon is a debugger daemon. This method should return true if the daemon instance is a
	 * debugger daemon listener. Not all of the registered daemons are necessarily debugger daemons, thus, this method
	 * is required to identify the ones that are debugger-related.
	 * 
