...
public class ServersPluginImages {
	...
	public static final String IMG_DEBUGGER_TEST = NAME_PREFIX + "debugger_test.gif"; //$NON-NLS-1$
	...
	public static final ImageDescriptor DESC_DEBUGGER_TEST = createManaged(T_OBJ, IMG_DEBUGGER_TEST);
