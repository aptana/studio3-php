...
import com.aptana.editor.php.typebinding.IBinding;
...
public abstract class ASTNode implements Visitable {
	...
	public static final int GOTO_LABEL = 64;
	public static final int GOTO_STATEMENT = 65;
	public static final int CONSTANT_DECLARATION = 66;
	public static final int USE_STATEMENT_PART = 67;
	public static final int USE_STATEMENT = 68;
	public static final int LAMBDA_FUNCTION_DECLARATION = 69;
	public static final int NAMESPACE_NAME = 70;
	 ...
	 */
	class NodeList<T extends ASTNode> extends ArrayList<T> {
