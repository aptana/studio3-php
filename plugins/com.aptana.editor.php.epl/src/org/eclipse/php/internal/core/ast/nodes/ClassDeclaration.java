...
public class ClassDeclaration extends TypeDeclaration {
	...
	public static final StructuralPropertyDescriptor SUPER_CLASS_PROPERTY = new StructuralPropertyDescriptor();
	public static final StructuralPropertyDescriptor INTERFACES_PROPERTY = new StructuralPropertyDescriptor();
	...
	private ClassDeclaration(int start, int end, int modifier, Identifier className, Identifier superClass, Identifier[] interfaces, Block body) {
		...
		if (superClass != null) {
			...
			superClass.setDescriptor(ClassDeclaration.SUPER_CLASS_PROPERTY);
		}
	}
	...
	public ClassDeclaration(int start, int end, int modifier, Identifier className, Expression superClass, List interfaces, Block body) {
		this(start, end, modifier, className, superClass instanceof Identifier?(Identifier)superClass:null, interfaces == null ? null : (Identifier[]) interfaces.toArray(new Identifier[interfaces.size()]), body);
	}
