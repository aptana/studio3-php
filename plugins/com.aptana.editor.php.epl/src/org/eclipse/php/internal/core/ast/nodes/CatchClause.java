...
public class CatchClause extends Statement {
	...
	public CatchClause(int start, int end, Expression className, Expression variable, Block statement) {
		super(start, end);
	...
	public Variable getVariableAsVariable() {
		return (Variable) (variable instanceof Variable?variable:new Variable(0, 0,""));
	}
}
