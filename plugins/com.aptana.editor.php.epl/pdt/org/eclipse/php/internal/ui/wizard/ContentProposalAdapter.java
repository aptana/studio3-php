package org.eclipse.php.internal.ui.wizard;
...
public class ContentProposalAdapter
{
	...
	class ContentProposalPopup extends PopupDialog
	{
		...
		private final class TargetControlListener implements Listener
		{
			...
			public void handleEvent(Event e)
			{
				...
				switch (key)
				{
					...
					case SWT.TAB:
						if (!getShell().isDisposed()&&getShell().isVisible())
						{
							e.doit = false;
		 ...
		 * table will contain a list of all the proposals. @param parent The parent composite to contain the dialog
		 * area; must not be <code>null</code>.
		 */
	 ...
	 */
	public static final boolean DEBUG = PHPEplPlugin.DEBUG;
	 ...
	 *            the <code>IControlContentAdapter</code> used to obtain and update the control's contents as
	 *            proposals are accepted. May not be <code>null</code>.
	 ...
	 *            parameter is <code>null</code>, then all alphanumeric characters will auto-activate content
	 *            proposal.
	 */
	 ...
	 *         invoke content proposal. If this value is <code>null</code> and the keyStroke value is
	 ...
	 *            invocation keyStroke was specified. If this parameter is <code>null</code>, then only a specified
	 *            keyStroke will invoke content proposal. If this parameter is <code>null</code> and the keyStroke
	 *            value is <code>null</code>, then all alphanumeric characters will auto-activate content proposal.
	 */
	 ...
	 *         <code>FILTER_NONE</code> specifies that no filtering will occur in the content proposal list as keys
	 *         are typed. <code>FILTER_CUMULATIVE</code> specifies that the content of the popup will be filtered by a
	 *         string containing all the characters typed since the popup has been open. <code>FILTER_CHARACTER</code>
	 *         specifies the content of the popup will be filtered by the most recently typed character. The default is
	 ...
	 *            <code>FILTER_NONE</code> specifies that no filtering will occur in the content proposal list as keys
	 *            are typed. <code>FILTER_CUMULATIVE</code> specifies that the content of the popup will be filtered
	 *            by a string containing all the characters typed since the popup has been open.
	 *            <code>FILTER_CHARACTER</code> specifies the content of the popup will be filtered by the most
	 ...
	 * 
	 * @param enabled
	 *            <code>true</code> if the adapter is enabled and responding to user input, <code>false</code> if it
	 ...
	 * 
	 * @param listener
	 *            the IContentProposalListener to be added as a listener. Must not be <code>null</code>. If an
	 *            attempt is made to register an instance which is already registered with this instance, this method
	 *            has no effect.
	...
	/*
	 * A content proposal has been accepted. Update the control contents accordingly and notify any listeners. @param
