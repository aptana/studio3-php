...
public class PhpLexerFactory {
	...
	public static AbstractPhpLexer createLexer(Reader reader,
		...
		if (phpVersion == PHPVersion.PHP4) {
			return new org2.eclipse.php.internal.core.documentModel.parser.php4.PhpLexer(
					reader);
		}
		if (phpVersion == PHPVersion.PHP5) {
			return new org2.eclipse.php.internal.core.documentModel.parser.php5.PhpLexer(
					reader);
		}
		if (phpVersion == PHPVersion.PHP5_3) {
			return new org2.eclipse.php.internal.core.documentModel.parser.php53.PhpLexer(
					reader);
		}
		if (phpVersion == PHPVersion.PHP5_4) {
			return new org2.eclipse.php.internal.core.documentModel.parser.php54.PhpLexer(
					reader);
		}
