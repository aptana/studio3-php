 ...
 *******************************************************************************/
package org.eclipse.php.internal.debug.ui.wizard;
 ...
 * <li><code>updateContents</code>: updates the cell editor's 'display value' control after its value has changed</li>
...
public abstract class TextDialogCellEditor extends CellEditor
{
	...
	static
	{
		...
		reg.put(CELL_EDITOR_IMG_DOTS_BUTTON, ImageDescriptor.createFromFile(TextDialogCellEditor.class,
	...
	private class DialogCellLayout extends Layout
	{
		public void layout(Composite editor, boolean force)
		{
			...
			button.setBounds(pos - dx, -delta, size.x, bounds.height + delta);
		}
	...
	{
		defaultLabel = new Text(cell, SWT.READ_ONLY | SWT.LEFT);
	...
	/*
	 * (non-Javadoc) Override in order to remove the button's focus listener if the celleditor is deactivating.
	 * 
	 ...
	 *            the parent control cell editor's window so that a subclass can adjust the dialog box accordingly
