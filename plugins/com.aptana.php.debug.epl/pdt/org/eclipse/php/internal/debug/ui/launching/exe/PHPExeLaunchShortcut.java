...
//				}
				...
				if (phpExeName == null) {
					...
					PreferencesUtil.createPreferenceDialogOn(PHPDebugEPLPlugin.getActiveWorkbenchShell(), "org.eclipse.php.debug.ui.preferencesphps.PHPsPreferencePage", null, null).open();
					return;
				}
