...
public class PHPLineBreakpoint extends LineBreakpoint {
    ...
    protected org2.eclipse.php.internal.debug.core.zend.debugger.Breakpoint fBreakpoint;
    ...
    public PHPLineBreakpoint(final IResource resource, final int lineNumber) throws CoreException {
        ...
        IWorkspaceRunnable runnable = new IWorkspaceRunnable() {
            public void run(IProgressMonitor monitor) throws CoreException {
                IMarker marker = resource.createMarker("org2.eclipse.php.debug.core.PHPConditionalBreakpointMarker");
    ...
    protected void createRuntimeBreakpoint(IMarker marker) throws CoreException {  
        ...
        fBreakpoint = new org2.eclipse.php.internal.debug.core.zend.debugger.Breakpoint(fileName, (lineNumber.intValue()));
        fBreakpoint.setEnable(true);
    }

    public org2.eclipse.php.internal.debug.core.zend.debugger.Breakpoint getRuntimeBreakpoint() {
        return fBreakpoint;
    }
