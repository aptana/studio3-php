...
public interface Debugger {
     ...
     * request, false otherwise.
     */
    public boolean getVariableValue(String value, int depth, String[] path, VariableValueResponseHandler responseHandler);
    ...
    public static interface GetStackVariableValueResponseHandler {
        ...
        public void stackVariableValue(int stackDepth, String value, int depth, String[] path, String reslut, boolean success);
    ...
    public interface DebugResponseHandler extends BreakpointAddedResponseHandler, BreakpointRemovedResponseHandler, AllBreakpointRemovedResponseHandler, StartResponseHandler, EvalResponseHandler, StepIntoResponseHandler, StepOverResponseHandler, StepOutResponseHandler, GoResponseHandler,
            PauseResponseHandler, AssignValueResponseHandler, VariableValueResponseHandler, GetCallStackResponseHandler, GetStackVariableValueResponseHandler {
