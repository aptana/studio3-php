...
public class DebugMessagesRegistry {
	...
	private DebugMessagesRegistry() {
		...
		for (final IConfigurationElement element : configElements) {
			...
			SafeRunnable.run(new SafeRunnable("Error creation extension for extension-point org2.eclipse.php.internal.debug.core.phpDebugMessages") {
	...
	class DebugMessageHandlerFactory {
		...
		public IDebugMessageHandler createHandler() {
			...
			SafeRunnable.run(new SafeRunnable("Error creation handler for extension-point org2.eclipse.php.internal.debug.core.phpDebugMessages") {
				public void run() throws Exception {
