...
import org2.eclipse.php.internal.debug.core.launching.PHPStreamsProxy;
...
public class PHPConsoleColorProvider extends ConsoleColorProvider {
	...
	private final static String PHP_DEBUG_STREAM = PHPDebugEPLPlugin.PLUGIN_ID + ".PHP_CONSOLE_STREAM"; //$NON-NLS-1$
	...
	private static IPHPConsoleEventListener[] getConsoleEventListeners() {
		if (fConsoleEventListeners == null) {
			...
			IConfigurationElement[] elements = registry.getConfigurationElementsFor(PHPDebugEPLPlugin.PLUGIN_ID, "phpConsoleListeners"); //$NON-NLS-1$
